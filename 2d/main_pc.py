...
for target in target_list: 
   ...
   modes, eigenvalues2, pratio,eigenf_imgs_smpr,targets = get_eigenpairs_v2(EPS,nreq,Bsc,V,L,plotefuns,eigenfunplotfile,eigenfunmontagefile,eigenfun_smpr_file,target,mesh,eigenfunh5file)
